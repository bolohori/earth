        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-12 col-lg-8">
                    <h3 class="category text-uppercase">Partner organisations</h3>
                    <div class="row">
    ...
    <section id="save-earth" class="w-100 text-center order-sm-first order-md-2">
        ...
        <form id="ep-searchform" action="/" method="post">
            <div class="form-group m-0">
                <input class="form-control text-center border-0" placeholder="Zip Code or City...">
            </div>
        </form>
    </section>
