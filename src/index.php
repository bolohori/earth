                    ...
                    <article class="featured side-article">
                        <div class="row">
                            <div class="col-12 col-md-6">
                                <img class="img-fluid d-block d-sm-none" src="./assets/images/placeholder%20images/env-ts-featured.jpg" alt="Featured image">
                                <img class="img-fluid d-none d-sm-block" src="./assets/images/placeholder%20images/env-ts-featured.jpg" alt="Featured image">
